...
Este projeto foi refeito utilizando Vue e Node.js nas versões mais recentes.

![Preview](https://github.com/omnweb/Vue-Calculator/blob/master/Calculator%20(1).gif?raw=true)
